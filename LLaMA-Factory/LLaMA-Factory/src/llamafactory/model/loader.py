...
def load_tokenizer(model_args: "ModelArguments") -> "TokenizerModule":
    ...
    # 本地路径时加 local_files_only=True，避免 HF 把路径当 repo_id 校验报错
    if os.path.isdir(os.path.abspath(model_args.model_name_or_path)):
        init_kwargs = {**init_kwargs, "local_files_only": True}
    try:
