...
# 单卡时补全分布式相关环境变量，避免 Seq2SeqTrainingArguments/PartialState 报错
# （device=1,num_gpus=1 或 WORLD_SIZE expected, but not set）
_cuda_devs = os.environ.get("CUDA_VISIBLE_DEVICES", "")
if _cuda_devs.strip() and "," not in _cuda_devs:
